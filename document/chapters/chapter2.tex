...
Firstly, the integration with the Microsoft framework MYSQL database is more simple when using \ac{ASP.NET} Core due to the package Entity Framework. % [https://learn.microsoft.com/en-us/aspnet/entity-framework]
