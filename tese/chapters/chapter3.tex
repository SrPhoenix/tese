...
Use cases were developed for each type of user to systematically describe their interactions within the system. Each sub-section below outlines the main responsibilities of a particular role, followed by the respective use cases.
...
To better understand how users interact with the system and with each other, i designed a flow chart based on the developed use cases. The overall workflow is shown in \ref{fig:appWorkflow}.
...
% In addition to this main workflow, the system supports several secondary interactions, also represented in \ref{fig:appWorkflow}.

% \begin{itemize}
%   \item Clients can check the status of their maintenance (Use Case 5.1).
%   \item Mechanics view their assigned tasks (Use Case 2.1). 
%   \item Receptionists access client information (Use Case 1.3).
%   \item Warehouse operators view stock information (Use Case 3.1).
%   \item Administrators assign roles and permissions to employees (Use Case 4.4). 
%   \item Administrators review maintenance records and generate statistics (Use Cases 4.2 and 4.3). 
% \end{itemize}
