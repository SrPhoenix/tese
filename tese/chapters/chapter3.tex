...
The non-functional requirements of the system were defined following the FURPS model and are summarized in Table~\ref{tab:nfr}. These requirements ensure that, \textbf{beyond providing the necessary functionalities}, the system also delivers \textbf{high standards of quality, performance, usability, and maintainability}.
