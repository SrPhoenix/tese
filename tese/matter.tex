...
% \includepdf[pages=-]{figs/Implementation/workshopmanager/report.pdf}
% \includepdf[pages=-]{figs/chapter5/UserTestsTasks.pdf}
% \includepdf[pages=-]{figs/chapter5/AplicationQuestionaire.pdf}
