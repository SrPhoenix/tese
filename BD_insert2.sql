...
INSERT INTO [dbo].[MaintenanceTasksType]
           ...
           ,[Type])
     VALUES
            (1,null,'Presão dos pneus',null,'Usando a bomba de ar, aumentar o ar dos pneus até estar acima do valor X,XX.',null,5.2,1,1),
            (1,null,'Nível do óleo',null,'Por óleo no veículo até estar X,XX.',null,2.2,1,1),
            (1,null,'Apertos',null,'Apertar os parafusos da bicicleta',null,1.1,2,1),   
            (2,null,'Trocar Pneus',null,'Substituir os pneus da bicicleta',null,1.1,1,1),   
            (2,1,'Trocar selim',null,'Substituir o selim da bicicleta',1,1.2,2,1),   
            (2,7,'Trocar motor',null,'Substituir o motor da bicicleta',1,1.3,3,1),   
            (2,9,'Trocar bateria',null,'Substituir a bateria da bicicleta',1,1.4,4,1),   
            (3,null,'Verificar pneus',null,'Verificar a pressão de ar dos pneus',null,1.1,1,2),   
            (3,null,'Verificar óleo',null,'Verificar o nível de óleo da bicicleta',null,1.2,2,2),   
            (3,null,'Verificar apertos',null,'Verificar os apertos da bicicleta',null,1.3,3,2),   
            (3,null,'Lavagem',null,'Lavar a bicicleta',null,1.4,4,2)
GO
...
INSERT INTO [dbo].[OwnerVehiclePartType]
           ([Code]
           ,[Name]
           ,[Description]
           ,[Price]
     ...
     VALUES
           ...
           ('PO789','Pneus Português','Descrição apropriada para estes pneus',1.5,8,8),
		   	('BQ123','Bateria da China','Descrição apropriada para esta bateria',3.15,9,20),
           ('BQ456','Bateria da Guiné','Descrição apropriada para esta bateria',2.20,9,15),
           ('BQ789','Bateria Português','Descrição apropriada para esta bateria',1.5,9,8)
GO

rollback


INSERT INTO [dbo].[OwnerVehiclePart]
           ([VehiclePartTypeId]
           ,[VehicleId]
           ,[DateIn]
           ,[DateOut])
...
INSERT INTO [dbo].[MaintenanceTaskStep]
           ...
           ,[Description])
     VALUES
		   (1,1,'Preparação','Colocar a bicicleta na máquina porreira'),
		   (2,1,'Preparação','Colocar a bicicleta na máquina porreira'),
		   (2,2,'Mudança de óleo','ir buscar o bidão do óleo'),
		   (2,3,'Finalizar','Tirar a bicicleta na máquina porreira'),
		   (3,1,'Preparação','Colocar a bicicleta na máquina porreira'),
           (3,2,'Apertos','Ver a máquina de apertos ligada à bicla'),
		   (3,3,'Finalizar','Tirar a bicicleta na máquina porreira'),
		   (4,1,'Preparação','Colocar a bicicleta na máquina porreira'),
           (4,2,'Trocar Pneus','Tirar muitas coisas a prender os pneus'),
		   (4,3,'Finalizar','Tirar a bicicleta na máquina porreira'),
		   (5,1,'Preparação','Colocar a bicicleta na máquina porreira'),
           (5,2,'Trocar selim','Tirar muitas coisas a prender o Selim'),
		   (5,3,'Finalizar','Tirar a bicicleta na máquina porreira'),
		   (6,1,'Preparação','Colocar a bicicleta na máquina porreira'),
           (6,2,'Trocar motor','Tirar muitas coisas a prender o motor'),
           (6,3,'Finalizar','Por Bicla à beira das outras'),
		   (7,1,'Preparação','Colocar a bicicleta na máquina porreira'),
           (7,2,'Trocar bateria','Tirar muitas coisas a prender a bateria'),
           (7,3,'Finalizar','Por Bicla à beira das outras'),
		   (8,1,'Verificar pneus','Verificar a pressão de ar dos pneus'),
		   (9,1,'Verificar óleo','Verificar o nível de óleo da bicicleta'),
		   (10,1,'Verificar apertos','Verificar os apertos da bicicleta'),
		   (11,1,'Lavagem','lavar muito bem')
GO
...
INSERT INTO [dbo].[Supplier]
     ...
     VALUES
           ('LightMobie'
           ,258125346
           ,'mobicycleSupplier@mobi.pt'
           ,'Rua da bicicleta n 25')
GO

USE [MobiCycle]
GO

INSERT INTO [dbo].[OwnerVehiclePartSupplier]
           ([SupplierId]
           ,[VehiclePartTypeId]
           ,[OwnerId]
           ,[DateIn]
           ,[ExpectedDateOut])
     VALUES
           ('8B3DDDC5-86D9-4B32-A3E4-46FC592C2B73','F71D1CF2-C7AD-4903-A733-16207BF3B393','1925D918-7D36-4539-A780-8F01090148D9',GETUTCDATE(),'3000-01-01 00:00:00.000'),
			('8B3DDDC5-86D9-4B32-A3E4-46FC592C2B73','2931086C-8F4C-468A-94FB-1CBEC103F979','1925D918-7D36-4539-A780-8F01090148D9',GETUTCDATE(),'3000-01-01 00:00:00.000'),
			('8B3DDDC5-86D9-4B32-A3E4-46FC592C2B73','4D2F9AFC-D5A9-43E2-A681-24FA739CF868','1925D918-7D36-4539-A780-8F01090148D9',GETUTCDATE(),'3000-01-01 00:00:00.000'),
			('8B3DDDC5-86D9-4B32-A3E4-46FC592C2B73','D11E4DA6-AA02-480C-A8DD-27052CDF6ABE','1925D918-7D36-4539-A780-8F01090148D9',GETUTCDATE(),'3000-01-01 00:00:00.000'),
			('8B3DDDC5-86D9-4B32-A3E4-46FC592C2B73','CA8FA5E2-8649-496E-87AE-2D1171F94DBE','1925D918-7D36-4539-A780-8F01090148D9',GETUTCDATE(),'3000-01-01 00:00:00.000'),
			('8B3DDDC5-86D9-4B32-A3E4-46FC592C2B73','9C3293EF-069E-43D9-809A-33CA5CC348E7','1925D918-7D36-4539-A780-8F01090148D9',GETUTCDATE(),'3000-01-01 00:00:00.000'),
			('8B3DDDC5-86D9-4B32-A3E4-46FC592C2B73','70CD9009-C55C-4EE3-9955-36E07467C772','1925D918-7D36-4539-A780-8F01090148D9',GETUTCDATE(),'3000-01-01 00:00:00.000')
...
INSERT INTO [dbo].[OwnerServiceTypeConfig]
           ([OwnerServiceTypeId]
           ,[ServiceTypeConfigId]
           ,[DateIn])
     VALUES
           ('EC038FF6-7A6F-4D59-BB58-0D19826A83CD',2,GETUTCDATE()),
           ('EC038FF6-7A6F-4D59-BB58-0D19826A83CD',1,GETUTCDATE()),
           ('24C73E68-E66B-4C4E-BB58-DDE21771C7A4',2,GETUTCDATE())
GO
